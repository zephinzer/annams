...
module.exports = {
  cors: {
    allowed: {
      hosts: (process.env.SERVER_CORS_ALLOWED_HOSTS === 'string') ? process.env.SERVER_CORS_ALLOWED_HOSTS.split(',') : DEFAULT_CORS_ALLOWED_HOSTS,
      methods: (process.env.SERVER_CORS_ALLOWED_METHODS === 'string') ? process.env.SERVER_CORS_ALLOWED_METHODS.split(',') : DEFAULT_CORS_ALLOWED_METHODS,
    },
  },
  log: {
